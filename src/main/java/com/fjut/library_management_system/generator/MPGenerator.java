package com.fjut.library_management_system.generator;
...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        DataSourceConfig dsc = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/library_management_system?&useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai","root","fujianz123")
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("entity")//实体类包名
                .parent("com.fjut.library_management_system")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
